...
class ClientAdapter(private val mCursor: Cursor): RecyclerView.Adapter<ClientViewHolder>(){
    ...
    override fun onBindViewHolder(holder: ClientViewHolder, position: Int) {
        ...
        holder.clientTitle.text = mCursor.getString(mCursor.getColumnIndex("Titulo"))
        holder.clientDescription.text = mCursor.getString(mCursor.getColumnIndex("descrição"))
    }
